#ifndef PARALYSIS_PROOF_SETTLE_H
#define PARALYSIS_PROOF_SETTLE_H
...
public:
  ...
  bool Validate() const {
    return validate_redeemScript(params.deposit_redeemScript(),
...
public:
  ...
  bool Sign(const CKey &exch_key, CMutableTransaction &unsigned_tx,
...
#endif // PARALYSIS_PROOF_SETTLE_H
