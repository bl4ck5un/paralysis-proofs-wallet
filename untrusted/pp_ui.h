...
public:
  ...
  void retranslateUi(QWidget *Wallet) {
    ...
    label_5->setText(QApplication::translate(
        "Wallet", "(This is a demo. Don't use it with real coins!!)", nullptr));
    left->setTitle(
        QApplication::translate("Wallet", "Wallet Information", nullptr));
    label->setText(QApplication::translate("Wallet", "RedeemScript", nullptr));
    redeemScript->setPlaceholderText(QApplication::translate(
        "Wallet", "hex string for the wallet redeemScript", nullptr));
    label_2->setText(QApplication::translate("Wallet", "Wallet UTXO", nullptr));
    utxo->setPlaceholderText(QApplication::translate(
        "Wallet", "hex string for the wallet deposit TX", nullptr));
    loadButton->setText(
        QApplication::translate("Wallet", "Load Wallet Information", nullptr));
    walletinfo->setPlaceholderText(QApplication::translate(
        "Wallet", "Wallet info will appear here...", nullptr));
    right->setTitle(
        QApplication::translate("Wallet", "Change Access Control", nullptr));
    label_3->setText(QApplication::translate("Wallet", "accuse who:", nullptr));
    accused->setPlaceholderText(
        QApplication::translate("Wallet", "e.g., 0, 1, 2, ...", nullptr));
    label_4->setText(QApplication::translate("Wallet", "fee tx", nullptr));
    feeTx->setPlaceholderText(QApplication::translate(
        "Wallet", "hex string for the fee payment TX", nullptr));
    accuseButton->setText(
        QApplication::translate("Wallet", "Accues!", nullptr));
    Tx1->setPlaceholderText(
        QApplication::translate("Wallet", "TX1 will appear here...", nullptr));
    Tx2->setPlaceholderText(
        QApplication::translate("Wallet", "TX2 will appear here...", nullptr));
    loadExampleButton->setText(
        QApplication::translate("Wallet", "Load Example", nullptr));
    exitButton->setText(QApplication::translate("Wallet", "Quit", nullptr));
    label_7->setText(QApplication::translate(
        "Wallet", "2019 (R) bl4ck5unxx@gmail.com", nullptr));
  } // retranslateUi
};
